...
| **Backend Total** | **341** | |
| | | |
| **E2E: Playwright** | **207** | **UI tests (Chromium, data-testid locators)** |
...
│       └── test/java/org/fabt/                        # 341 tests (unit + integration)
...
│   ├── playwright/                                    # UI tests (207 tests, Chromium + nginx profile)
