...
# │  NEVER use this key in production. A production deployment     │
# │  with this key means every TOTP secret is encrypted with a     │
# │  publicly known key — equivalent to no encryption at all.      │
# │                                                                │
# │  Production: generate a unique key with `openssl rand -base64 32` │
# │  and store it in ~/fabt-secrets/.env.prod (never in Git).      │
# └─────────────────────────────────────────────────────────────────┘
...
echo ""
info "Login credentials — three demo tenants (all passwords: admin123):"
echo -e "  ${YELLOW}Central (slug: dev-coc)${NC} — Development CoC (baseline, NOAA: KRDU)"
echo -e "    Admin:       admin@dev.fabt.org"
echo -e "    CoC Admin:   cocadmin@dev.fabt.org"
echo -e "    Outreach:    outreach@dev.fabt.org"
echo -e "    DV Outreach: dv-outreach@dev.fabt.org"
echo -e "  ${YELLOW}West (slug: dev-coc-west)${NC} — Blue Ridge CoC (demo) (Boone/Waynesville, NOAA: KAVL)"
echo -e "    Admin:       admin@blueridge.fabt.org"
echo -e "    CoC Admin:   cocadmin@blueridge.fabt.org"
echo -e "    Coordinator: coordinator@blueridge.fabt.org"
echo -e "    Outreach:    outreach@blueridge.fabt.org"
echo -e "    DV Coord:    dv-coordinator@blueridge.fabt.org"
echo -e "    DV Outreach: dv-outreach@blueridge.fabt.org"
echo -e "  ${YELLOW}East (slug: dev-coc-east)${NC} — Pamlico Sound CoC (demo) (New Bern/Washington, NOAA: KEWN)"
echo -e "    Admin:       admin@pamlico.fabt.org"
echo -e "    CoC Admin:   cocadmin@pamlico.fabt.org"
echo -e "    Coordinator: coordinator@pamlico.fabt.org"
echo -e "    Outreach:    outreach@pamlico.fabt.org"
echo -e "    DV Coord:    dv-coordinator@pamlico.fabt.org"
echo -e "    DV Outreach: dv-outreach@pamlico.fabt.org"
echo ""
