...
import { ContactSettings, DvPolicySettings, ReservationSettings, Spinner, TabErrorBoundary } from './components';
...
export function AdminPanel() {
  ...
  return (
    <div style={{ maxWidth: 900, margin: '0 auto' }}>
      ...
      {/* Contact Email Settings (tenant-wide, always visible — info-email-contact §5.7) */}
      <ContactSettings />
